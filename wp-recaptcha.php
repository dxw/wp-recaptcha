...
function recaptcha_wp_options_subpanel() {
   global $wpmu;
	...
	if (isset($_POST['submit'])) {
		...
		'use_mailhide_posts' => isset($_POST['use_mailhide_posts']) ? $_POST['use_mailhide_posts'] : '',
		'use_mailhide_comments' => isset($_POST['use_mailhide_comments']) ? $_POST['use_mailhide_comments'] : '',
		'use_mailhide_rss' => isset($_POST['use_mailhide_rss']) ? $_POST['use_mailhide_rss'] : '',
		'use_mailhide_rss_comments' => isset($_POST['use_mailhide_rss_comments']) ? $_POST['use_mailhide_rss_comments'] : '',
		're_bypass' => isset($_POST['re_bypass']) ? $_POST['re_bypass'] : '',
		're_bypasslevel' => $_POST['re_bypasslevel'],
		'mailhide_pub' => trim($_POST['mailhide_pub']),
		'mailhide_priv' => trim($_POST['mailhide_priv']),
		'mh_bypass' => isset($_POST['mh_bypass']) ? $_POST['mh_bypass'] : '',
		...
		're_comments' => isset($_POST['re_comments']) ? $_POST['re_comments'] : '',
		're_registration' => isset($_POST['re_registration']) ? $_POST['re_registration'] : '',
		're_xhtml' => isset($_POST['re_xhtml']) ? $_POST['re_xhtml'] : '',
